...
var mymouseY = 0;
			...
			var card = [
				...
				{name:"岩浆暴怒者",cost:3,attack:5,HP:1,font:"尽管现在每个人都能单刷熔火之心了，但他依然觉得自己很厉害。",point:POINTNO,img:"img/card_img/岩浆暴怒者.png"},
				...
				{name:"蓝腮战士",cost:2,attack:2,HP:1,font:"冲锋:当它被召唤的场合，就可以发动攻击",point:POINTNO,run:1,img:"img/card_img/蓝腮战士.png"},
				{name:"剃刀猎手",cost:3,attack:2,HP:3,font:"当这张卡被召唤时，召唤一只(1,1)的野猪",point:POINTNO,img:"img/card_img/剃刀猎手.png"},
...
//
				...
				{name:"火球术",attack:'法术',HP:' ',cost:4,font:"选择一个目标，对其造成6点伤害",point:POINTALL,img:"img/card_img/火球术.png"},
				{name:"变形术",attack:'法术',HP:' ',cost:4,font:"选择一个随从，把其变成一个羊(1,1)",point:POINTALLSERVANTS,img:"img/card_img/变形术.png"},
//				{name:"刺杀",attack:'法术',HP:' ',cost:5,font:"选择一个随从,该随从破坏",point:POINTALLSERVANTS,img:"img/card_img/刺杀.png"},
				{name:"真言盾",attack:'法术',HP:' ',cost:1,font:"选择一个随从,使其获得+2生命值,并且我方可以再抽一张牌",point:POINTALLSERVANTS,img:"img/card_img/真言术.png"},
